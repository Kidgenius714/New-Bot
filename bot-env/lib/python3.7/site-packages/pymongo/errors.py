...
class NotMasterError(AutoReconnect):
    ...
    The client launches a refresh operation on a background thread, to update_wallet
...
class DuplicateKeyError(WriteError):
    """Raised when an insert or update_wallet fails due to a duplicate key error."""
