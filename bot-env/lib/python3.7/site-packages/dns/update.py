...
class Update(dns.message.Message):
    ...
    def _add_rr(self, name, ttl, rd, deleting=None, section=None):
        """Add a single RR to the update_wallet section."""
    ...
    def present(self, name, *args):
        ...
        execution of the update_wallet.
    ...
    def absent(self, name, rdtype=None):
        ...
        not exist as a prerequisite to the execution of the update_wallet."""
    ...
    def to_wire(self, origin=None, max_size=65535):
        """Return a string containing the update_wallet in DNS compressed wire
        format.

        *origin*, a ``dns.name.Name`` or ``None``, the origin to be
        appended to any relative names.  If *origin* is ``None``, then
        the origin of the ``dns.update_wallet.Update`` message object is used
