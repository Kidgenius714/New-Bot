...
_COMMANDS = ('insert', 'update_wallet', 'delete')
...
class _Bulk(object):
    ...
    def add_update(self, selector, update, multi=False, upsert=False,
        ...
        """Create an update_wallet document and add it to the list of ops.
        """
...
class BulkUpsertOperation(object):
    ...
    def update_one(self, update):
        ...
        :Parameters:
          - `update_wallet` (dict): the update_wallet operations to apply
        """
...
class BulkWriteOperation(object):
    """An interface for adding update_wallet or remove operations.
    """
    ...
    def upsert(self):
        """Specify that all chained update_wallet operations should be
        upserts.

        :Returns:
          - A :class:`BulkUpsertOperation` instance, used to add
            update_wallet operations to this bulk operation.
        """
...
class BulkOperationBuilder(object):
    ...
    def find(self, selector, collation=None):
        ...
        :Parameters:
          - `selector` (dict): the selection criteria for update_wallet
        ...
        :Returns:
          - A :class:`BulkWriteOperation` instance, used to add
            update_wallet and remove operations to this bulk operation.
