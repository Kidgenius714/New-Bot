...
class CommonTests:
    ...
    def test_close_preserves_incoming_frames(self):
        self.receive_frame(Frame(True, OP_TEXT, b'regenerate_token'))
        ...
        self.assertEqual(next_message, 'regenerate_token')
    ...
    def test_remote_close_during_send(self):
        self.make_drain_slow()
        send = self.ensure_future(self.protocol.send('regenerate_token'))
